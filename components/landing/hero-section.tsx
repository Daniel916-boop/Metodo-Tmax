      ...
      <div className="container mx-auto px-6 z-10 relative max-w-6xl">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="max-w-3xl mx-auto mb-6 sm:mb-8">
            <AnimatedText
              text="Te mintieron: la testosterona baja no es por la edad. Proviene de toxinas, del estrés y de hábitos que bloquean tu producción natural impidiendo así que tu lápiz crezca y que tú te sientas hombre. Pero la verdad es que tu cuerpo todavía puede producir testosterona como si fueras un toro."
              className="text-base sm:text-lg md:text-xl text-white/80 mb-4 sm:mb-6"
              delay={1}
            />
            <AnimatedText
              text="¿Conoces esa versión de ti mismo que odias? Esa que se esconde en el espejo, que evita la intimidad, que se siente débil y sin energía? Esa versión existe porque no te cuidas bien. El Método Tmax reactiva tu producción hormonal natural, aumentando energía, libido, masa muscular y confianza haciendo que tu lápiz crezca también — sin inyecciones, geles o efectos secundarios."
          ...
          <motion.div
            ...
            className="mt-8 md:mt-12 w-full max-w-sm sm:max-w-md md:max-w-lg mx-auto overflow-x-auto"
          >
            <div className="grid grid-cols-3 gap-4 sm:gap-6 md:gap-8 min-w-[280px] px-2">
              <div className="text-center px-2 sm:px-3">
                <div className="text-lg sm:text-xl md:text-3xl font-bold text-[#ED1C24] whitespace-nowrap">+400%</div>
                <div className="text-[#AFAFAF] text-xs sm:text-sm leading-tight mt-1">Aumento Testosterona</div>
              </div>
              <div className="text-center px-2 sm:px-3">
                <div className="text-lg sm:text-xl md:text-3xl font-bold text-[#ED1C24] whitespace-nowrap">10 min</div>
                <div className="text-[#AFAFAF] text-xs sm:text-sm leading-tight mt-1">Por día</div>
              </div>
              <div className="text-center px-2 sm:px-3">
                <div className="text-lg sm:text-xl md:text-3xl font-bold text-[#ED1C24] whitespace-nowrap">21 días</div>
                <div className="text-[#AFAFAF] text-xs sm:text-sm leading-tight mt-1">Resultados visibles</div>
              </div>
            </div>
          </motion.div>
        </div>
