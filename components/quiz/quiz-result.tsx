...
export default function QuizResult({ currentLevel, desiredIncrease, onContinue }: QuizResultProps) {
  ...
  const getOfferDetails = () => {
    switch (desiredIncrease) {
      case 400:
        return {
          url: "https://pay.hotmart.com/O101750536R",
          price: "$7",
          originalPrice: "$17.50",
          label: "400%"
        }
      case 100:
        return {
          url: "https://pay.hotmart.com/I101751436I",
          price: "$6",
          originalPrice: "$15.00",
          label: "100%"
        }
      case 50:
        return {
          url: "https://pay.hotmart.com/A101759645A?bid=1757104171911",
          price: "$5",
          originalPrice: "$12.50",
          label: "50%"
        }
      case 25:
        return {
          url: "https://pay.hotmart.com/X101760189R",
          price: "$4",
          originalPrice: "$10.00",
          label: "25%"
        }
        ...
        >
          ...
          <div className="bg-red-900/20 border border-red-500/30 p-4 rounded-lg mb-4">
            <div className="text-center mb-3">
              <h3 className="text-white font-bold text-lg">Tu Oferta Personalizada</h3>
              <p className="text-gray-300 text-sm">Protocolo {offer.label} - Optimización Hormonal</p>
            </div>
            <div className="flex items-center justify-center gap-4 mb-3">
              ...
              <div className="text-center">
                ...
                <div className="bg-red-600 text-white text-xs px-2 py-1 rounded-full">60% OFF</div>
              </div>
            </div>
          </div>
