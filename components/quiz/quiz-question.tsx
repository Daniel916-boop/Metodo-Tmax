            ...
            <table className="w-full text-left text-gray-300">
              <thead>
                <tr className="border-b border-gray-700">
                  ...
                  <th className="py-2 px-4">AUMENTO</th>
              ...
              <tbody>
                <tr className="border-b border-gray-700">
                  ...
                  <td className="py-2 px-4">4.0 cm</td>
                  <td className="py-2 px-4 text-red-500 font-bold">$7</td>
                  <td className="py-2 px-4"><span className="line-through text-gray-500">$17.50</span> (60% OFF)</td>
                </tr>
                <tr className="border-b border-gray-700">
                  <td className="py-2 px-4">100%</td>
                  <td className="py-2 px-4">2.0 cm</td>
                  <td className="py-2 px-4 text-red-500 font-bold">$6</td>
                  <td className="py-2 px-4"><span className="line-through text-gray-500">$15.00</span> (60% OFF)</td>
                </tr>
                <tr className="border-b border-gray-700">
                  <td className="py-2 px-4">50%</td>
                  <td className="py-2 px-4">1.0 cm</td>
                  <td className="py-2 px-4 text-red-500 font-bold">$5</td>
                  <td className="py-2 px-4"><span className="line-through text-gray-500">$12.50</span> (60% OFF)</td>
                </tr>
                <tr>
                  <td className="py-2 px-4">25%</td>
                  <td className="py-2 px-4">0.5 cm</td>
                  <td className="py-2 px-4 text-red-500 font-bold">$4</td>
                  <td className="py-2 px-4"><span className="line-through text-gray-500">$10.00</span> (60% OFF)</td>
                </tr>
              </tbody>
            </table>
          </div>
