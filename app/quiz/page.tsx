...
export default function QuizPage() {
  ...
  const questions = [
    ...
    {
      id: "energy",
      question: "¿Cómo evalúas tu nivel de energía y disposición a lo largo del día?",
      options: [
    ...
    {
      id: "muscle_mass",
      question: "¿Has notado cambios en tu masa muscular o dificultad para ganar músculos, incluso entrenando?",
      options: [
    ...
    {
      id: "sleep_quality",
      question: "¿Cómo está la calidad de tu sueño? ¿Te despiertas descansado?",
      options: [
    ...
    {
      id: "mood",
      question: "¿Has experimentado alteraciones del humor, como irritabilidad, ansiedad o desánimo?",
      options: [
    ...
    {
      id: "libido",
      question: "¿Con qué frecuencia sientes deseo sexual (libido)?",
      options: [
    ...
    {
      id: "erection_quality",
      question: "¿Cómo evalúas la calidad de tus erecciones?",
      options: [
    ...
    {
      id: "orgasm_quality",
      question: "¿Has tenido orgasmos satisfactorios e intensos?",
      options: [
    ...
    {
      id: "current_size",
      question: "¿Cuál es el tamaño actual de tu pene erecto (en centímetros)?",
      options: [
    ...
    {
      id: "desired_increase",
      question: "¿Cuántos centímetros te gustaría aumentar en el tamaño de tu pene?",
      options: [
    ...
    // Categoría 4: Objetivo de Aumento de Testosterona y Relación con Crecimiento
    {
      ...
      question: "¿Cuánto te gustaría aumentar tu nivel de testosterona em 30 dias? (Valores: 400% + 4.0 CM 7 dol, 100% + 2.0 CM 6 dol, 50% + 1.0 CM 5 dol, 25% + 0.5 CM 4 dol)",
      options: [
        { value: "400", label: "400% + 4.0 CM 7 dol", percentage: 400 },
        { value: "100", label: "100% + 2.0 CM 6 dol", percentage: 100 },
        { value: "50", label: "50% + 1.0 CM 5 dol", percentage: 50 },
        { value: "25", label: "25% + 0.5 CM 4 dol", percentage: 25 },
      ],
      type: "single",
    },
  ]
