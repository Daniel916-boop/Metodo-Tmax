...
export default function QuizPage() {
  ...
  const questions = [
    ...
    // Categoría 4: Objetivo de Aumento de Testosterona y Relación con Crecimiento
    {
      ...
      options: [
        { value: "25", label: "25% (Potencial de aumento de 1 cm de lápiz)", percentage: 25 },
        { value: "50", label: "50% (Potencial de aumento de 1.5 cm de lápiz)", percentage: 50 },
        { value: "100", label: "100% (Potencial de aumento de 2.5 cm de lápiz)", percentage: 100 },
