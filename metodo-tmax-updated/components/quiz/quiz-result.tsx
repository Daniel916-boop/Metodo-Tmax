...
export default function QuizResult({ currentLevel, userName, onContinue }: QuizResultProps) {
  const desiredIncrease = 400 - currentLevel // Aumento para chegar próximo ao máximo
  const finalLevel = Math.min(currentLevel + desiredIncrease, 400)
      ...
      <div className="w-full max-w-4xl px-4">
        <div className="text-center mb-6">
          <h1 className="text-2xl md:text-3xl font-bold mb-2">
            {userName ? `${userName}, tu` : "Tu"} Resultado <span className="text-red-500">Personalizado</span>
          </h1>
        ...
        >
          <div className="text-center mb-6">
            <h2 className="text-xl font-bold text-white">
              {userName ? `${userName}, puedes` : "Puedes"} aumentar hasta <span className="text-red-500 text-3xl">400%</span> tu testosterona
            </h2>
            <p className="text-gray-400 mt-2">Tu nivel hormonal tiene potencial para optimizarse en solo 21 días</p>
          </div>
          ...
          <div className="relative h-16 bg-gray-800 rounded-lg overflow-hidden mb-6">
            <div 
              ...
              style={{ width: `${Math.min(currentLevel / 4, 50)}%` }}
            >
            ...
            <div 
              ...
              style={{ width: `${Math.min(100 - (currentLevel / 4), 50)}%` }}
            >
          ...
          <div className="bg-gray-800 p-4 rounded-lg mb-4">
            <h3 className="text-white font-bold mb-3">
              {userName ? `Resumen de tu análisis, ${userName}:` : "Resumen de tu análisis:"}
            </h3>
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-center">
                <span className="text-gray-300">Aumento posible:</span>
                <span className="text-red-400 font-bold">+{400 - currentLevel}%</span>
              </div>
          ...
          <div className="bg-gray-800 p-3 rounded-lg mb-4">
            <div className="flex items-start">
              ...
              <p className="text-gray-300 text-sm">
                ...
                en <span className="font-bold text-white">21 días</span> siguiendo nuestro protocolo.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-800 p-3 rounded-lg">
            <div className="flex items-start">
              ...
              <p className="text-gray-300 text-sm">
                ...
                <span className="font-bold text-white">10 minutos por día</span> para resultados hormonales efectivos.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            {userName ? `Comenzar Mi Protocolo, ${userName}` : "Comenzar Mi Protocolo Personalizado"}
          </button>
          <p className="mt-3 text-gray-400 text-xs">
            Tu protocolo de optimización hormonal fue creado basado en tus respuestas.
            <br />
            Comienza ahora y siente la diferencia en solo 21 días.
          </p>
        </motion.div>
      </div>
    </div>
